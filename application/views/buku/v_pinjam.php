...
<body>
	<?php echo form_open('c_perpus/input_simpan'); ?>
	<form action="c_perpus/input_simpan" method="post">
		...
		<div class="container">
                    <?php echo anchor('c_perpus','<button type="button" class="kembali"> Kembali </button>'); ?>
		</div>
	</form>
    <?php echo form_close(); ?>
</body>
